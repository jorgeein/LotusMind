...
urlpatterns = [
    ...
    path('mihistorial', views.historial, name="historial"),
    ...
    path('resultado_encuesta/<int:respuesta_encuesta_id>/',
         views.resultado_encuestaafter, name='resultado_encuestaafter'),
    path('resultado_encuesta', views.resultado_encuesta, name='resultado_encuesta'),
    path('recurso/<str:nombre_rec>/',
         views.recursoindividual, name="recursoindividual"),
